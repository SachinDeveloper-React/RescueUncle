...
const FaqIcon = (props: Props) => {
  return (
    <Svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <Path d="M9 7L13 7" stroke="#FF5963" strokeLinecap="round" />
      <Path d="M9 15L12 15" stroke="#FF5963" strokeLinecap="round" />
      <Path d="M9 11L15 11" stroke="#FF5963" strokeLinecap="round" />
      <Path
